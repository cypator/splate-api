...
<aside class="notice">
Cypator supports Term orders only for time in force (59) FOK, client will need to state the term asset in tag Currency (15) e.g. for symbols BTC/USD client will send USD on tag Currency <br/>
